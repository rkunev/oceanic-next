...
export const green_650 = '#5aa352ff'; // oklch(0.648 0.137 142)
...
export const cyan_650 = '#379a9aff'; // oklch(0.63 0.09 195)
export const cyan_600 = '#4b6f7b44'; // oklch(0.519 0.045 221 / 0.27)
