...
export const dark_hint_background = withAlpha(dark_hint, 0.08);
export const dark_hint_border = dark_hint;
export const dark_info = blue_500;
export const dark_info_background = withAlpha(dark_info, 0.08);
export const dark_info_border = dark_info;
export const dark_success = green_500;
export const dark_success_background = withAlpha(dark_success, 0.08);
export const dark_success_border = green_400;
export const dark_warning = orange_500;
export const dark_warning_background = withAlpha(dark_warning, 0.08);
export const dark_warning_border = dark_warning;
export const dark_error = red_500;
export const dark_error_background = withAlpha(dark_error, 0.08);
...
export const dark_deleted_background = withAlpha(dark_deleted, 0.08);
...
export const dark_renamed_background = withAlpha(dark_renamed, 0.08);
export const dark_renamed_border = dark_renamed;
export const dark_hidden = cyan_700;
export const dark_hidden_background = withAlpha(dark_hidden, 0.08);
export const dark_hidden_border = dark_hidden;
export const dark_ignored = cyan_700;
export const dark_ignored_background = withAlpha(dark_ignored, 0.08);
...
export const dark_predictive_background = withAlpha(dark_predictive, 0.08);
...
export const dark_unreachable_background = withAlpha(dark_unreachable, 0.08);
